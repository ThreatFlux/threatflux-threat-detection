...
fn test_detector_default() {
    ...
    assert_eq!(detector.engine_count(), 0);
    assert_eq!(detector.get_config().max_file_size, 100 * 1024 * 1024);
    assert_eq!(detector.get_config().scan_timeout.as_secs(), 300);
    assert_eq!(detector.get_config().max_concurrent_scans, 4);
}
