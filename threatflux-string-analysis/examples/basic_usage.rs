...
fn main() -> anyhow::Result<()> {
    ...
    tracker.track_string(
        ...
        "a1b2c3d4e5f6",
        "malware_scanner",
        StringContext::FileString { offset: Some(0x1000) }
    )?;
    ...
    tracker.track_string(
        ...
        "f6e5d4c3b2a1",
        "file_scanner",
        StringContext::Metadata { field: "user_agent".to_string() }
    )?;
