...
//!
//! // Scan memory data instead of a file
//! let test_data = b"This is test data for scanning";
//! let result = detector.scan_data(test_data, Some("test_file.txt")).await?;
//!
...
impl ThreatDetector {
    ...
    async fn scan(&self, target: ScanTarget) -> Result<ThreatAnalysis> {
        ...
        let classifications_vec: Vec<ThreatClassification> =
